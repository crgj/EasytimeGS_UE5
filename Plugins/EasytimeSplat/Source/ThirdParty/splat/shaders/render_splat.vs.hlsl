 ...
 * chosen value of 蟽.
 * @param out_sig_div_sqrt_2 - the radius of the splat, in 蟽's, over sqrt(2).
...
void main(in uint in_id : SV_VertexID,
  ...
  /**
	 ...
	 *
	 * 1. Each transform t is of radius 1蟽. Scale to the desired number of
	 * standard deviations 蟽.
	 ...
	 * 4. Per vertex, out_sig_div_sqrt_2 is +- x蟽/sqrt(2). this is interpolated by
	 * the fragment shader, and used to determine the distance in 蟽 from the
  ...
  // Distance from center, in 蟽, for interpolating in fragment shader.
