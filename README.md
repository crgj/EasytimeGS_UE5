...
### v1.4 (2026-04-06)
- **Actor 缩放支持** - Splat4DActor 的 Scale3D 属性正确影响高斯位置和形状
- **透明度控制** - 新增 Opacity 属性，支持整体透明度实时调节
- **渲染稳定性优化** - 修复动态属性更新时的渲染闪烁问题

### v1.3 (2026-04-05)
- **颜色渲染修复** - 4DGS DC/SH 颜色通道正确解码显示
- **透明度通道** - 支持各高斯点透明度混合

### v1.1 (2026-04-05)
- **4DGS 位置与旋转** - 修复 PLY4 导入后的坐标系转换，位置/旋转正确渲染
